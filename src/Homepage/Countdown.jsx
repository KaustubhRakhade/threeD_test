  ...
  return (
    ...
    <>
        <Text
          ...
          outlineColor={color}
          outlineWidth={0.01}
          outlineOpacity={0.25}>{countdownText}</Text>
          <Text
          scale={[size,size,1]}
          position={position}
          rotation={rotation}
          ...
          outlineColor={color}
          outlineWidth={0.06}
          outlineOpacity={0.2}>{countdownText}</Text>
          <Text
          scale={[size,size,1]}
          position={position}
          rotation={rotation}
          ...
          outlineColor={color}
          outlineWidth={0.12}
          outlineOpacity={0.1}>{countdownText}</Text>
          <Text
          scale={[size,size,1]}
          rotation={rotation}
          position={position}
          ...
          outlineColor={color}
          outlineWidth={0.25}
          outlineOpacity={0.05}>{countdownText}</Text>
    </>
  )
}
